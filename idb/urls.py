...
# missing some intersections
    ...
    url(r'^people/(\d+)/', 'idb.api.views.people_id', name='people_api'),
    url(r'^api/people/(\d+)/', 'idb.api.views.people_id', name='people_api'),
    url(r'^companies/(\d+)/', 'idb.api.views.companies_id', name='companies_api'),
    url(r'^api/companies/(\d+)/', 'idb.api.views.companies_id', name='companies_api'),
